...
final class MFieldInt16DedupeTests: TestBase {
    ...
    func testDifferentArchiveID() throws {
        ...
        let s1 = MFieldInt16.create(testContext, task: t1, name: "foo", userOrder: 4, archiveID: fieldArchiveID1, createdAt: date1, value: 7, upperBound: 20, stepValue: 1)
        let s2 = MFieldInt16.create(testContext, task: t1, name: "bar", userOrder: 8, archiveID: fieldArchiveID2, createdAt: date2, value: 13, upperBound: 20, stepValue: 1)
        try testContext.save() // needed for fetch request to work properly

        try MFieldInt16.dedupe(testContext, taskArchiveID: taskArchiveID1, fieldArchiveID: fieldArchiveID1)
    ...
    func testSameArchiveIdWithinTask() throws {
        ...
        let t1 = MTask.create(testContext, routine: c1, userOrder: 10, archiveID: taskArchiveID1, createdAt: date1)
        let s1 = MFieldInt16.create(testContext, task: t1, name: "foo", userOrder: 4, archiveID: fieldArchiveID1, createdAt: date1, value: 7, upperBound: 20, stepValue: 1)
        let s2 = MFieldInt16.create(testContext, task: t1, name: "bar", userOrder: 8, archiveID: fieldArchiveID1, createdAt: date2, value: 13, upperBound: 20, stepValue: 1)
        try testContext.save() // needed for fetch request to work properly
    ...
    func testSameArchiveIdOutsideTask() throws {
        ...
        let s1 = MFieldInt16.create(testContext, task: t1, name: "foo", userOrder: 4, archiveID: fieldArchiveID1, createdAt: date1, value: 7, upperBound: 20, stepValue: 1)
        let s2 = MFieldInt16.create(testContext, task: t2, name: "bar", userOrder: 8, archiveID: fieldArchiveID1, createdAt: date2, value: 13, upperBound: 20, stepValue: 1)
        try testContext.save() // needed for fetch request to work properly
